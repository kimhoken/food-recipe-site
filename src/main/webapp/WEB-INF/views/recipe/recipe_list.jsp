            ...
            <aside class="filter-area">
                <form name="frm" action="${pageContext.request.contextPath}/recipe_list.do" method="get">
                    ...
                    <div class="filter-section">
                        <h4>카테고리</h4>
                        <label>
                            <input type="radio" name="category" value="상황별추천" <c:if test="${recipeSearchDTO.category eq '상황별추천'}">checked</c:if>> 
                            ⭐ 상황별 추천
                        </label>

                        <label>
                            <input type="radio" name="category" value="한식" <c:if test="${recipeSearchDTO.category eq '한식'}">checked</c:if>> 
                            🍚 한식
                        </label>

                        <label>
                            <input type="radio" name="category" value="양식"<c:if test="${recipeSearchDTO.category eq '양식'}">checked</c:if>> 
                            🍝 양식
                        </label>

                        <label>
                            <input type="radio" name="category" value="중식" <c:if test="${recipeSearchDTO.category eq '중식'}">checked</c:if>> 
                            🍳 중식
                        </label>

                        <label>
                            <input type="radio" name="category" value="일식" <c:if test="${recipeSearchDTO.category eq '일식'}">checked</c:if>> 
                            🍣 일식
                        </label>

                        <label>
                            <input type="radio" name="category" value="아시안" <c:if test="${recipeSearchDTO.category eq '아시안'}">checked</c:if>> 
                            🌏 아시안
                        </label>

                        <label><input type="radio" name="category" value="건강식/다이어트"<c:if test="${recipeSearchDTO.category eq '건강식/다이어트'}">checked</c:if>> 
                            🥗 건강식/다이어트
                        </label>

                        <label>
                            <input type="radio" name="category" value="초간단요리" <c:if test="${recipeSearchDTO.category eq '초간단요리'}">checked</c:if>> 
                            ⏱️ 초간단요리
                        </label>

                        <label>
                            <input type="radio" name="category" value="디저트" <c:if test="${recipeSearchDTO.category eq '디저트'}">checked</c:if>> 
                            🍰 디저트
                        </label>

                        <label>
                            <input type="radio" name="category" value="베이킹" <c:if test="${recipeSearchDTO.category eq '베이킹'}">checked</c:if>> 
                            🍞 베이킹
                        </label>

                        <label>
                            <input type="radio" name="category" value="음료/차" <c:if test="${recipeSearchDTO.category eq '음료/차'}">checked</c:if>> 
                            ☕ 음료/차
                        </label>
                    </div>
