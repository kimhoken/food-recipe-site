                    ...
                    <aside class="filter-area">
                        ...
                        <div class="filter-section">
                            ...
                            <%-- 삼항 연산자를 써서 코드를 훨씬 깔끔하게 만들기 --%>
                                ...
                                <label><input type="radio" name="category" value="한식" ${recipeSearchDTO.category eq '한식'
                                        ? 'checked' : '' }> 🍚 한식</label>
                                <label><input type="radio" name="category" value="양식" ${recipeSearchDTO.category eq '양식'
                                        ? 'checked' : '' }> 🍝 양식</label>
                                <label><input type="radio" name="category" value="중식" ${recipeSearchDTO.category eq '중식'
                                        ? 'checked' : '' }> 🍳 중식</label>
                                <label><input type="radio" name="category" value="일식" ${recipeSearchDTO.category eq '일식'
                                        ? 'checked' : '' }> 🍣 일식</label>
                                <label><input type="radio" name="category" value="아시안" ${recipeSearchDTO.category
                                        eq '아시안' ? 'checked' : '' }> 🌏 아시안</label>
                                <label><input type="radio" name="category" value="건강식/다이어트" ${recipeSearchDTO.category
                                        eq '건강식/다이어트' ? 'checked' : '' }> 🥗 건강식/다이어트</label>
