            ...
            <form>
                <table border="1" align="center">
                    ...
                    <tr>
                        <th>비밀번호</th>
                        <td>
                            <input type="password" id="pwd" name="pwd" placeholder="비밀번호 입력하세요" oninput="pwdchange()"/>
                            <div id="pwd_msg">영문 특수문자 10글자 이상</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>비밀번호 확인</th>
                        <td>
                            <input type="password" id="pwd_check" name="pwd_check" placeholder="비밀번호 확인 입력하세요" oninput="pwdchange()"/>
